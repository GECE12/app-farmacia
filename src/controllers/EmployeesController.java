...
public class EmployeesController implements ActionListener, MouseListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == views.btn_register_employee) {
            ...
            if (views.txt_employee_id.getText().equals("")
                    ...
                    || views.cmb_employee_role.getSelectedItem().toString().equals("")
              ...
              employee.setRol(views.cmb_employee_role.getSelectedItem().toString());
    ...
    public void mouseClicked(MouseEvent e) {
        if(e.getSource() == views.employees_table) {
            ...
            views.cmb_employee_role.setSelectedItem(views.employees_table.getValueAt(row, 6).toString());
